    ...
    <header className="w-full bg-black">
      <div className="max-w-7xl mx-auto h-20 px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center">
          <img src={Logo} alt="e.PN logo" className="h-8 md:h-[40px] w-auto" />
        </div>
        ...
        <div className="flex items-center gap-4 md:gap-6 text-white text-sm">
          ...
          <Link to="/auth.epn">
            <button className="relative group px-4 md:px-5 py-1.5 rounded-full border border-[#E7C9A5] text-white overflow-hidden text-xs md:text-sm">
              Login / Sign Up
