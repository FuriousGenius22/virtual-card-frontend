  ...
  return (
    <div className="w-full h-full px-6 py-8 font-sans">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 md:p-6">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="flex justify-center items-center 
                              w-14 h-14 rounded-full bg-[#2563EB]">
              ...
              <div className="flex-1 flex justify-between items-center">
                ...
                <p className="text-[28px] font-semibold text-[#111827]">$0
                  <span className="text-[16px] font-normal">.00</span>
                </p>
              </div>
            </div>
          </Link>
        ...
        <Link
          to="/decline-board"
          className="block w-full mt-6 border border-gray-200 rounded-xl 
                     hover:bg-[#F9FAFB] transition px-6 py-4 cursor-pointer"
        >
          <div className="flex flex-col md:flex-row md:items-center 
            ...
            <div className="flex items-center gap-2 justify-start">
              ...
              <p className="text-[28px] font-semibold text-[#059669] ml-3">
                0%
              </p>
            </div>
            ...
            <div className="flex flex-wrap md:flex-nowrap items-center 
                            text-[14px] text-[#6B7280] gap-6 md:gap-10">
